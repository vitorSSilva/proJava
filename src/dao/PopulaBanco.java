...
public class PopulaBanco {
	...
	public static void main(String[] args) {
		...
		Autor assis = geraAutor("Machado de Assis", "machadao.assis@outlook.com.br");
		em.persist(assis);

		Autor amado = geraAutor("Jorge Amado","ja.amado@hotmail.com");
		em.persist(amado);

		Autor coelho = geraAutor("Paulo Coelho", "pc@gmail.com");
		em.persist(coelho);
		...
		/*usuario*/
		Usuario user = geraUsuario("user.alfa@omega.com.br", "12345");
		em.persist(user);
	...
	private static Livro geraLivro(String isbn, String titulo, String data,
		...
		livro.setDataLancamento(parseData(data));//convertido para data ( Calendar )
